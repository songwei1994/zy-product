    ...
    <div class="tableInspe">
      ...
      >
        ...
        <el-table-column align="center" label="状态" show-overflow-tooltip>
          <template slot-scope="scope">
            <div>
              <span style="border: 2px solid #017FFA;padding: 2px 10px;font-weight: 500" :class="{'borderStatus': scope.row.status === 1}"> {{ scope.row.status | statusFilter }}</span>
            </div>
          </template>
        </el-table-column>
      </el-table>
